...
import { Code2, Database, Cpu, Paintbrush } from "lucide-react";
import {
  FaReact,
  FaNodeJs,
  FaPython,
...
const SkillsSection = () => {
  ...
  { name: "Canva", icon: <FaFigma className="w-4 h-4 text-[#F24E1E]" /> },
      ],
    },
    {
      icon: Paintbrush,
      ...
      skills: [
        { name: "Problem Solving", icon: <Cpu className="w-4 h-4 text-[#FF6D00]" /> },
        { name: "Teamwork", icon: <FcWorkflow className="w-4 h-4" /> },
        { name: "Creativity", icon: <MdAnimation className="w-4 h-4 text-[#FF4081]" /> },
        { name: "Time Management", icon: <BsGrid1X2 className="w-4 h-4 text-[#9CA3AF]" /> },
      ],
    },
  ];
