...
export default function Hero() {
  ...
  "Learning MERN Stack",
  "Open to Web & Discord Development Opportunities",
  ];

  const [code] = useState(`
const profile = {
    name: 'Sakshi Sharma',
    title: 'Full-Stack Developer | Creative Problem Solver | Tech Innovator',
    skills: [
       'MERN Stack','VsCode','Postman','Bootstrap','javaScript',
        'MySQL',  
        'Git', 
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    experience: "Fresher | Open to opportunities",
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
  Full-Stack Developer 🚀 | MERN & Web Enthusiast 💻 | Building modern website✨
</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/sak-shar00/"
                ...
                {/* Contact Button */}
               <a
  href="https://drive.google.com/file/d/1goQeQqpTfkhaHnvLP26XZevPkRRzkAo0/view?usp=drivesdk"
  target="_blank"
